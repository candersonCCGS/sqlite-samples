...
print(f'<h1>Cities of {country}</h1>')
print(f'<p>The following table lists some of the main cities of {country}. The cities are listed in order of population size.</p>')
#
#####
...
#
cursor.execute('''SELECT City.name, City.province, City.population FROM City
                    INNER JOIN Country
                    WHERE City.country = Country.code
                    AND   Country.name = :country
                    ORDER BY City.population DESC''', values)
